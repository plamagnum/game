...
<body leftmargin=5 topmargin=5 marginwidth=5 marginheight=5 bgcolor=transparent onload="<?=topsethp()?>">
...
<INPUT TYPE=button value="Подсказка" style="background-color:#A9AFC0" onclick="window.open('help/c.html', 'help', 'height=300,width=500,location=no,menubar=no,status=no,toolbar=no,scrollbars=yes')">
