...
<TR><TD><!--Рюкзак-->
<TABLE BORDER=0 WIDTH=100% CELLSPACING="1" CELLPADDING="2" BGCOLOR="transparent">
<?
...
<div><A HREF="zoo.php?otdel=5&sid=&0.648834385828923"><? if ($_GET["otdel"]==5) echo "<DIV style='background-color: transparent'>";?>Заклинания: нейтральные<? if ($_GET["otdel"]==5) echo "</div>";?></A></div>

<div><A HREF="zoo.php?otdel=50&sid=&0.925798340638547"><? if ($_GET["otdel"]==50) echo "<DIV style='background-color: transparent'>";?>Амуниция: Еда<? if ($_GET["otdel"]==50) echo "</div>";?></A></div>
	</div>
